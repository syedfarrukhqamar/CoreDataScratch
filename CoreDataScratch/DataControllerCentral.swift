...
class DataControllerCentral {
    ...
    func addIngredientsToProduct ( ingredientToRegister: String, productID: String, halal_haram_mushbooh_Status: String,ing_name: String, ing_descryption : String) {
        ...
        // print("")
        var ingredientsExistsOrNot = DataControllerCentral()
        var productCode = String()
        
        var productIngredientsSearchResult =  ingredientsExistsOrNot.createDBConnectionAndSearchFor("ProductsWithIngredients", columnName: "prd_id",searchString: productID,filtered: true) as! [AAAProductsWithIngredientsMO]
    ...
    func registerIngredientToProduct (productID: String, ingredientID: String, h_status: String, ing_name: String,ingredient_descryption: String){
        ...
        let productCheck = DataControllerCentral()
        ...
        let ingredientRegisterationCheck = DataControllerCentral()
